...
// ちょい派手用：背景にゆっくり動くグラデ（CSSで軽く）
const BG_GRADIENT =
    "radial-gradient(1200px 800px at 20% 10%, rgba(59,130,246,0.20), transparent 60%)," +
    "radial-gradient(900px 700px at 90% 20%, rgba(236,72,153,0.18), transparent 55%)," +
    "radial-gradient(900px 700px at 65% 90%, rgba(16,185,129,0.18), transparent 55%)," +
    "linear-gradient(135deg, #0B1020 0%, #0B1224 55%, #0B1020 100%)";
                        ...
                        return (
                            <button
                                ...
                                style={{
                                    ...
                                    boxShadow: isSelected
                                        ? `0 0 0 6px rgba(255,255,255,0.12), 0 18px 40px rgba(0,0,0,0.35)`
                            ...
                            >
                                ...
                                <span
                                    style={{
                                        ...styles.dotCore,
                                        background: `radial-gradient(circle at 30% 30%, rgba(255,255,255,0.65), ${d.color} 55%, rgba(0,0,0,0.28) 120%)`,
                                    }}
                                />
                                {/* label */}
...
const styles = {
    ...
    brandTitle: { fontWeight: 900, letterSpacing: 0.4, fontSize: 18 },
    ...
    bgLayer: {
        ...
        inset: 0,
        background:
            "radial-gradient(600px 380px at 20% 30%, rgba(59,130,246,0.22), transparent 60%)," +
            "radial-gradient(520px 360px at 85% 25%, rgba(236,72,153,0.18), transparent 60%)," +
            "radial-gradient(520px 360px at 70% 85%, rgba(16,185,129,0.18), transparent 60%)",
    ...
    msgHint: { opacity: 0.65, fontSize: 12 },
    ...
    userName: { fontWeight: 900, fontSize: 13, flex: "0 0 auto" },
    userDoing: { fontSize: 12, opacity: 0.78, marginLeft: "auto" },
